...
const translations = {
  en: {
    ...
    enableHumanLikeInteraction: 'Enable human-like browser interaction scan (logic bugs)',
    learningAndGuidance: 'Learning & Browser Guidance',
    writeupLinksInputLabel: 'Write-up Links for Learning',
    writeupLinksPlaceholder: 'https://portswigger.net/research/...\nhttps://hackerone.com/reports/...',
    interactionPathsInputLabel: 'Specific Paths to Navigate',
    interactionPathsPlaceholder: '/checkout\n/account/settings\n/admin/users\nhttps://target.example/orders/confirm',
    oneItemPerLineHint: 'One link/path per line',
    interactionPathsHint: 'Supports relative paths and full URLs',
    autoLearnerControlsTitle: 'Auto Write-up Learner Controls',
    autoLearnerStatusLabel: 'Status',
    autoLearnerRunning: 'Running',
    autoLearnerPaused: 'Paused',
    autoLearnerQueueLabel: 'Queue',
    autoLearnerLearnedLabel: 'Learned write-ups',
    autoLearnerRulesLabel: 'Imported rules',
    pauseAutoLearner: 'Pause learner',
    resumeAutoLearner: 'Resume learner',
    learnOneNow: 'Learn one now',
    autoLearnerLastLearned: 'Last learned URL',
    cleanupLearningData: 'Clean learned write-ups',
    learningCleanupDone: 'Learning cleanup completed',
    scanDurationMinutes: 'Timed Scan Duration (minutes)',
    scanDurationHint: '0 = single-cycle scan. Set >0 to keep scanning until time is up.',
    learningRuleUsagePercent: 'Learning Rules Usage (%)',
    learningRuleUsageHint: 'Use a subset of learned rules to reduce scan time.',
  ...
  ar: {
    ...
    enableHumanLikeInteraction: 'تفعيل فحص تفاعلي شبيه بالبشر (ثغرات منطقية)',
    learningAndGuidance: 'التعلّم وإرشاد المتصفح',
    writeupLinksInputLabel: 'روابط Write-ups للتعلّم',
    writeupLinksPlaceholder: 'https://portswigger.net/research/...\nhttps://hackerone.com/reports/...',
    interactionPathsInputLabel: 'مسارات محددة للتنقّل',
    interactionPathsPlaceholder: '/checkout\n/account/settings\n/admin/users\nhttps://target.example/orders/confirm',
    oneItemPerLineHint: 'عنصر واحد في كل سطر',
    interactionPathsHint: 'يدعم المسارات النسبية والروابط الكاملة',
    autoLearnerControlsTitle: 'عناصر التحكم بالتعلّم التلقائي',
    autoLearnerStatusLabel: 'الحالة',
    autoLearnerRunning: 'يعمل',
    autoLearnerPaused: 'متوقف مؤقتاً',
    autoLearnerQueueLabel: 'الطابور',
    autoLearnerLearnedLabel: 'Write-ups متعلَّمة',
    autoLearnerRulesLabel: 'القواعد المستوردة',
    pauseAutoLearner: 'إيقاف مؤقت',
    resumeAutoLearner: 'استئناف',
    learnOneNow: 'تعلّم واحدة الآن',
    autoLearnerLastLearned: 'آخر رابط تم تعلّمه',
    cleanupLearningData: 'تنظيف بيانات التعلّم',
    learningCleanupDone: 'اكتمل تنظيف التعلّم',
    scanDurationMinutes: 'مدة الفحص الزمني (بالدقائق)',
    scanDurationHint: '0 = دورة فحص واحدة. استخدم قيمة أكبر للاستمرار حتى انتهاء الوقت.',
    learningRuleUsagePercent: 'نسبة استخدام قواعد التعلّم (%)',
    learningRuleUsageHint: 'استخدم جزءاً من القواعد المتعلّمة لتقليل وقت الفحص.',
